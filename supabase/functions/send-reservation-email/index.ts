...
serve(async (req) => {
    ...
    try {
        ...
        const { subject, html } = getEmailTemplate(tipo, reservaData, reservaData.idioma)
        ...
        if (tipo === 'notificacion') {
            ...
            // TEMPORAL PARA PRUEBAS: Cambia este email por el tuyo para verificar que llegan las notificaciones
            to = 'reservas@restauranteavoa.com'  // ← Cambia esto por tu email personal
            // to = 'tu_email@gmail.com'  // ← Descomenta esta línea y pon tu email
